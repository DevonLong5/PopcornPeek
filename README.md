PopcornPeek is a movie lookup app that allows the user to look up movies by title or IMDb ID. It displays up to 12 movies at a time, displaying each one's poster, title, overview, and release date.
